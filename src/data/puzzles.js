const puzzles = [
  ...
  },
  {
    ...
    elements: [
      ...
      { type: "text", content: "גראלט, אמנם מצאת את האוצר- אבל זה עוד לא אומר שניצחנו. אני חוששת שכבר מאוחר מידי. תאנוס כבר בדרך אל הגביע! רוץ, רוץ מהר ככל שתוכל- אתה יודע איפה גביע הזהב נמצא. סירי." },
    ],
    targetLocation: {
      latitude: 31.2592,
      longitude: 34.7970,
