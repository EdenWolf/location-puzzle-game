const puzzles = [
  {
    ...
    type: "location",
    elements: [
      { type: "image", src: "/images/arthur-morgan.jpg", alt: "ארתור מורגן" },
  ...
  },
  {
    ...
    elements: [
      ...
      { type: "image", src: "/images/bench-clue.jpg", alt: "מסר נסתר על הספסל" },
  ...
  },
  {
    ...
    elements: [
      ...
      { type: "image", src: "/images/library-entrance.jpg", alt: "כניסת הספרייה" },
  ...
  },
  {
    ...
    elements: [
      ...
      { type: "image", src: "/images/completion.jpg", alt: "תעודת סיום" },
